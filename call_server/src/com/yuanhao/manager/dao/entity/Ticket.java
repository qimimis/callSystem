...
public class Ticket implements Serializable {
    ...
    public Ticket( int ticketNo, String ticketBusinessCode, String ticketBusinessName, Date ticketTakeTime, String ticketTakeIp, int ticketWaitCount,  Date ticketCallTime, int ticketCallCount,String ticketCallIp, int ticketCallWindow, String ticketCallerWorkno, byte ticketIsSuccess, String ticketDesc) {
