...
public class TestLoginUi extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TestLoginUi frame = new TestLoginUi();
	...
	public TestLoginUi() {
        ...
        titleLB.setIcon(new ImageIcon("src/com/yuanhao/pic/loginMg.jpg"));
        ...
        passwordLB.setFont(new Font("ï¿½ï¿½ï¿½ï¿½", Font.PLAIN, 16));
        ...
        usernameLB.setFont(new Font("ï¿½ï¿½ï¿½ï¿½", Font.PLAIN, 16));
	...
	private void login() {
        ...
        if (username.isEmpty()|| password.isEmpty()) {
			JOptionPane.showConfirmDialog(null,"ÓÃ»§ÃûºÍÃÜÂë²»µÃÎª¿Õ");
        }
		else {
